...
const skills = [
  ...
  { icon: <HiChartBar size={32} style={{ color: '#F2C811' }} />, url: 'https://powerbi.microsoft.com/', name: 'Power BI' },
];
        ...
        >
          ...
          >
            <motion.div 
              ...
              whileTap={{ scale: 0.98 }}
              className="mb-6 p-1 rounded-full bg-gradient-to-br from-blue-50 to-gray-50"
            >
              <ProfileImage />
            </motion.div>
            ...
            >
              {[...contacts, ...socials].map((item, idx) => (
                <motion.a
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="flex items-center justify-center p-3 rounded-lg border border-gray-200 bg-white hover:bg-blue-50 transition-all"
                >
              ...
              >
                {skills.map((skill, idx) => (
                  <motion.a
                    ...
                    className="flex flex-col items-center p-4 rounded-lg bg-gradient-to-br from-white to-gray-50 border border-gray-200 hover:border-blue-200 transition-all"
                  >
                    {skill.icon}
